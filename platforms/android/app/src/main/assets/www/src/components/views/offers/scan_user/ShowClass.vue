<template>
  <article>
    <div class="grid-container grid-frame offer_show_container" v-show="!show_camera">
        <app-header
          :transparent="true"
              ...
              <transition
                ...
                <div
                  ...
                  <div
                    ...
                    <div class="grid-x" v-if="offer.attributes.trainers.length > 0">
                      <div class="cell">
          ...
          onSuccess(result){
            ...
            try{
              ...
              vm.$http.post("app/offers/scan_location_qr",{
                ...
                this.$router.push({name: "my_classes"})
